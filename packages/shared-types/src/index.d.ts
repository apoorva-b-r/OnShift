...
export type ReconciliationStatus = 'MATCHED' | 'EXPLAINED_DIFFERENCE' | 'UNEXPLAINED_DIFFERENCE' | 'INSUFFICIENT_EVIDENCE';
export type VerificationLevel = 'DECLARED' | 'OBSERVED' | 'CORROBORATED' | 'FINANCIALLY_CORROBORATED';
